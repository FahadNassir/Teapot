...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray- min-w-full">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Opening Hours */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-900">Opening Hours</h3>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex justify-between items-center">
            <p className="text-gray-600">© 2025 Teapot Cafe. All rights reserved.</p>
